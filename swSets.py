...
english_contractions_tokens = {'get', 'must', 'this', 'wo', 'may', 'she',
'where', "who'd", 'who', "shouldn't", '(', 'which', "'d", 'I', 'so', 'what',
"'ll", 'gim', 'be', 'go', "'re", ')', 's', 'o', 'should', 'something', 'we',
"couldn't", "whom'st'd", 'na', 'me', "'t", "mustn't", 'shall', "'m", 'ought',
'sha', 'they', 'why', 'those', 'everyone', 'gon', "e'er", 'it', "ne'er",
"'cause", 'ai', 'finna', "'ve", "'s", "'", "o'er", 'could', 'ca', 'might',
'someone', 'somebody', 'these', 'you', "n't", 'da', "o'clock", 'would', 'let',
'there', 'noun', "we'd", 'ol', 'that', 'ta', 'he', "y'all", 'dare', 'need',
'when', 'a', 'how', 'have', 'do'}

sw = {'a', 'about', 'above', 'across', 'after', 'again', 'against', 'all',
'almost', 'alone', 'along', 'already', 'also', 'although', 'always', 'among',
'an', 'and', 'another', 'any', 'anybody', 'anyone', 'anything', 'anywhere',
'are', 'area', 'areas', 'around', 'as', 'ask', 'asked', 'asking', 'asks',
'at', 'away', 'b', 'back', 'backed', 'backing', 'backs', 'be', 'became',
'because', 'become', 'becomes', 'been', 'before', 'began', 'behind', 'being',
'beings', 'best', 'better', 'between', 'big', 'both', 'but', 'by', 'c',
...
'likely', 'long', 'longer', 'longest', 'm', 'made', 'make', 'making', 'man',
'many', 'may', 'me', 'member', 'members', 'men', 'might', 'more', 'most',
'mostly', 'mr', 'mrs', 'much', 'must', 'my', 'myself', 'n', 'necessary',
...
'out', 'over', 'p', 'part', 'parted', 'parting', 'parts', 'per', 'perhaps',
...
'youngest', 'your', 'yours', 'z', 'don', 'yeah', 're', 'okay', 'hey', 'll',
've', 'oh', 'didn', 'ok', 'am', 'yes', 'doin'}
